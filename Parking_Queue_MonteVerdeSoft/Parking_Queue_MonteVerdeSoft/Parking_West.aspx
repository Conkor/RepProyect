<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Parking_West.aspx.cs" Inherits="Parking_Queue_MonteVerdeSoft.Parking_West" %>
...
<head runat="server">
    ...
    <title>Parqueo Oeste - Parking Queue</title>
        ...
        <div id="page-wrapper">
            ...
            <div class="container-fluid">
				...
				<option value="16-17">16-17</option>
                     ...
                     <br />
				<input type="button" id="ButtonReserv" value="Reservar" runat="server"/>
				</aside>
                </section>
                </div>
                <!-- /.row -->
