<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Parking_MyN.aspx.cs" Inherits="Parking_Queue_MonteVerdeSoft.Parking_MyN" %>
...
<head runat ="server">
    ...
    <title>Parqueo Mu&ntilde;oz y Nanne - Parking Queue</title>
            ...
            <ul class="nav navbar-right top-nav">
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li class="divider"></li>
                        <li>
                            <a href="home.aspx"><i class="fa fa-fw fa-power-off"></i> Cerrar Sesión</a>
                        </li>
                    </ul>
                </li>
            </ul>
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-12">
                      ...
                      <section class="Main"> 
                    <img class="img-thumbnail" src="Images/Parqueo MyN.jpg" width="650" alt="">
                 <aside> 
