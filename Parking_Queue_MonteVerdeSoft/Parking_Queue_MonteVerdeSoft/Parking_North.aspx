<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Parking_North.aspx.cs" Inherits="Parking_Queue_MonteVerdeSoft.Parking_North" %>
...
<head runat="server">
    ...
    <title>Parqueo Norte - Parking Queue</title>
    ...
    <div id="wrapper">
            ...
            <ul class="nav navbar-right top-nav">
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li class="divider"></li>
                        <li>
                            <a href="indexLogin.aspx"><i class="fa fa-fw fa-power-off"></i> Cerrar Sesión</a>
                        </li>
                    </ul>
                </li>
            </ul>
        ...
        <div id="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <section class="Main"> 
                    <img class="img-thumbnail" src="Images/Parqueo Norte.png" width="350" alt="">
                 <aside> 
